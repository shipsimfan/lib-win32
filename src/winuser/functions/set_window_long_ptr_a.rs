...
use crate::{
    CallWindowProc, GetLastError, RegisterClassEx, SetLastError, SetParent, SetWindowLongPtr,
    SetWindowPos, CS_CLASSDC, CS_PARENTDC, GWLP_HINSTANCE, GWLP_ID, GWLP_USERDATA, GWLP_WNDPROC,
    GWL_EXSTYLE, GWL_STYLE, TRUE, WNDCLASSEX, WS_EX_COMPOSITED, WS_EX_LAYERED,
};
...
extern "system" {
    ...
    pub fn SetWindowLongPtrA(wnd: HWND, index: c_int, new_long: LONG_PTR) -> LONG_PTR;
}
