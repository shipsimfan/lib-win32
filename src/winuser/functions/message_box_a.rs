use crate::{HWND, LPCSTR, UINT};
use std::ffi::c_int;

// rustdoc imports
#[allow(unused_imports)]
use crate::{
    GetLastError, MessageBox, SetForegroundWindow, IDABORT, IDCANCEL, IDCONTINUE, IDIGNORE, IDNO,
    IDOK, IDRETRY, IDTRYAGAIN, IDYES, MB_ABORTRETRYIGNORE, MB_APPLMODAL, MB_CANCELTRYCONTINUE,
...
unsafe extern "system" {
    ...
    pub fn MessageBoxA(wnd: HWND, text: LPCSTR, caption: LPCSTR, r#type: UINT) -> c_int;
}
