use crate::{BOOL, LPOSVERSIONINFOW};
...
unsafe extern "system" {
    ...
    ///
    /// # Parameters
    ///  * `version_information` - An [`OSVERSIONINFOW`] or [`OSVERSIONINFOEXW`] structure that
    ...
    /// `os_version_info_size` member of the [`OSVERSIONINFOW`] or [`OSVERSIONINFOEXW`] structure.
    ///
    /// # Remarks
    ...
    pub fn GetVersionExW(version_information: LPOSVERSIONINFOW) -> BOOL;
}
