use crate::{
    BOOL, HANDLE, HDC, HMONITOR, HWND, INT_PTR, LPARAM, LPRECT, LRESULT, MSG, OSVERSIONINFOA,
    OSVERSIONINFOW, PAINTSTRUCT, RAWINPUTDEVICE, RAWINPUTDEVICELIST, UINT, WNDCLASSEXW, WNDCLASSW,
    WPARAM,
};
