use crate::{DefWindowProcW, HBRUSH, HCURSOR, HICON, HINSTANCE, LPCSTR, UINT, WNDPROC};
use std::{
    ffi::c_int,
    ptr::{null, null_mut},
};
...
use crate::{
    BeginPaint, CallWindowProc, RegisterClass, RegisterClassEx, UnregisterClass,
    COLOR_ACTIVEBORDER, COLOR_ACTIVECAPTION, COLOR_APPWORKSPACE, COLOR_BACKGROUND, COLOR_BTNFACE,
    COLOR_BTNSHADOW, COLOR_BTNTEXT, COLOR_CAPTIONTEXT, COLOR_GRAYTEXT, COLOR_HIGHLIGHT,
    COLOR_HIGHLIGHTTEXT, COLOR_INACTIVEBORDER, COLOR_INACTIVECAPTION, COLOR_MENU, COLOR_MENUTEXT,
    COLOR_SCROLLBAR, COLOR_WINDOW, COLOR_WINDOWFRAME, COLOR_WINDOWTEXT, DLGWINDOWEXTRA,
    MAKEINTRESOURCE, PAINTSTRUCT, WM_ERASEBKGND, WNDCLASS, WNDCLASSEX,
};
