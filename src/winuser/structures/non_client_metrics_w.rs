...
pub struct NONCLIENTMETRICSW {
    ...
    /// `std::mem::size_of::<NONCLIENTMETRICSW>()`.
    pub size: UINT,
...
impl Default for NONCLIENTMETRICSW {
    fn default() -> Self {
        NONCLIENTMETRICSW {
            size: std::mem::size_of::<NONCLIENTMETRICSW>() as _,
            border_width: 0,
            scroll_width: 0,
            scroll_height: 0,
            caption_width: 0,
            caption_height: 0,
            caption_font: LOGFONTW::default(),
            sm_caption_width: 0,
            sm_caption_height: 0,
            sm_caption_font: LOGFONTW::default(),
            menu_width: 0,
            menu_height: 0,
            menu_font: LOGFONTW::default(),
            status_font: LOGFONTW::default(),
            message_font: LOGFONTW::default(),
