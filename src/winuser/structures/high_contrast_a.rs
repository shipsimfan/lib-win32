use crate::{DWORD, LPSTR, UINT};

// rustdoc imports
#[allow(unused_imports)]
use crate::{
    SystemParametersInfo, SystemParametersInfoA, HCF_AVAILABLE, HCF_CONFIRMHOTKEY,
...
///
/// # Remarks
/// An application uses this structure when calling the [`SystemParametersInfoA`] function with the
...
pub struct HIGHCONTRASTA {
    ...
    ///                                   [`SystemParametersInfoA`] can cause theme change effects
