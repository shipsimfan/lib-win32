use crate::{DefWindowProc, HBRUSH, HCURSOR, HICON, HINSTANCE, LPCSTR, UINT, WNDPROC};
use std::ffi::c_int;

// rustdoc imports
#[allow(unused_imports)]
use crate::{
    BeginPaint, CallWindowProc, GetClassInfoEx, RegisterClass, RegisterClassEx, UnregisterClass,
    DLGWINDOWEXTRA, MAKEINTRESOURCE, PAINTSTRUCT, WM_ERASEBKGND, WNDCLASS, WNDCLASSEX,
};
#[allow(unused_imports)]
...
impl Default for WNDCLASSEXA {
    fn default() -> Self {
        WNDCLASSEXA {
            size: std::mem::size_of::<WNDCLASSEXA>() as u32,
            style: 0,
