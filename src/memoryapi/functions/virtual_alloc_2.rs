...
use crate::{
    GetLastError, LocalAlloc, VirtualAlloc, VirtualFree, VirtualFreeEx, VirtualProtectEx,
    ...
    MEM_RESET, MEM_RESET_UNDO, MEM_TOP_DOWN, PAGE_EXECUTE, PAGE_EXECUTE_READWRITE, PAGE_GUARD,
...
extern "system" {
    ...
    ///                       commitment state of each page. If BaseAddress specifies an address
