...
use crate::d3d11::{
    ...
    D3D11_FEATURE_DATA_D3D11_OPTIONS2, D3D11_FEATURE_DATA_D3D11_OPTIONS3,
    D3D11_FEATURE_DATA_D3D11_OPTIONS4, D3D11_FEATURE_DATA_D3D11_OPTIONS5,
    ...
    D3D11_FEATURE_DATA_FORMAT_SUPPORT2, D3D11_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT,
    D3D11_FEATURE_DATA_MARKER_SUPPORT, D3D11_FEATURE_DATA_SHADER_CACHE,
    D3D11_FEATURE_DATA_SHADER_MIN_PRECISION_SUPPORT, D3D11_FEATURE_DATA_THREADING,
...
pub enum D3D11_FEATURE {
    ...
    /// Supports a [`D3D11_SHARED_RESOURCE_TIER`] to indicate the level of support for shared
