...
pub use functions::{
    ...
    RegCreateKeyExW, RegCreateKeyTransacted, RegCreateKeyTransactedW, RegDeleteKeyEx,
    RegDeleteKeyExW, RegDeleteKeyTransacted, RegDeleteKeyTransactedW, RegLoadKey, RegLoadKeyW,
    ...
    RegSaveKeyExW, RegSaveKeyW, RegSetKeyValue, RegSetKeyValueW, RegSetValueEx, RegSetValueExW,
};
