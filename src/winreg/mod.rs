...
pub use functions::{
    ...
    RegDeleteKeyEx, RegDeleteKeyExW, RegDeleteKeyTransacted, RegDeleteKeyTransactedW, RegLoadKey,
    ...
    RegSaveKey, RegSaveKeyEx, RegSaveKeyExW, RegSaveKeyW, RegSetKeyValue, RegSetKeyValueW,
